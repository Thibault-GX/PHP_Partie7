    ...
    <div class="row bg-info">
      <div class="col-2 bg-primary">
        <nav class="nav flex-column font-weight-bold">
          ...
          <a class="nav-link text-warning" href="../Ex6/index.php">Ex6</a>
          <a class="nav-link text-warning" href="../Ex7/index.php">Ex7</a>
          <a class="nav-link text-warning" href="../Ex8/index.php">Ex8</a>
        </nav>
      </div>
